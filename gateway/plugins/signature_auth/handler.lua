...
function SignatureAuthHandler:access(conf)
    ...
    local enable = gateway_db.get("signature_auth.enable")
    local meta = gateway_db.get_json("signature_auth.meta")
    local selectors = gateway_db.get_json("signature_auth.selectors")
