...
local counter = require("gateway.plugins.rate_limiting.counter")
...
function RateLimitingHandler:access(conf)
    ...
    local enable = gateway_db.get("rate_limiting.enable")
    local meta = gateway_db.get_json("rate_limiting.meta")
    local selectors = gateway_db.get_json("rate_limiting.selectors")
